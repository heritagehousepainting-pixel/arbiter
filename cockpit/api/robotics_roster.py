...
``docs/specs/research/robotics_map.json`` and hand-curated.
...
private chokepoints kept visible as tagged reference rows (no live price).

This module CANNOT make any symbol trade-eligible; it never touches
``sectors.py`` / ``_DEFAULT_WATCHLIST``
...
# Each dict matches cockpit.api.contract.RoboticsRosterEntry.
_ROSTER: tuple[dict, ...] = (
    # ======================= compute =======================
