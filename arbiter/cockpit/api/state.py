...
# The arbiter Python package is importable from the repo root. Add it to
# sys.path for read-only reuse of config + AlpacaAdapter. Done once, lazily,
# only when we touch Alpaca.
...
def _data_source_intensities(conn: sqlite3.Connection) -> dict[str, NodeState]:
    ...
    # filings-backed sources: form4, form13d, congress
    source_to_node = {
        "form4": "src.form4",
        "form13d": "src.form13d",
